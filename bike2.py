...
class Bike:
    ...
    def __init__(self, numGears=1, currentGear=1, numWheels=2, brakeType="hand brakes"):
    ...
    # here is the code for update the gear
    def updateCurrentGear(self, currentGear: int) -> None:
        if 1 <= currentGear <= self.__numGears:
            self.__currentGear = currentGear
        else:
            print("Invalid current gear value")
